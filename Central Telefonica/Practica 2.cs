    ...
    class Practica2
    {
        static void Main(string[] args)
        {
            ...
            MySQLInserter inserter = new MySQLInserter();
            ...
            inserter.InsertarLlamada(new LlamadaLocal("8091234567", "8097654321", 120));
            inserter.InsertarLlamada(new LlamadaProvincial("8291234567", "8097654321", 180, 1));
            inserter.InsertarLlamada(new LlamadaLocal("8491234567", "8297654321", 60));
            inserter.InsertarLlamada(new LlamadaProvincial("8091234567", "8497654321", 240, 2));
